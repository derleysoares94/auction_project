...
const Register = () => {
    ...
    return (
        <VStack minH='500px' w='70%' maxW='600px' justifyContent='start' alignItems='start'>
            ...
            <Button mb='10px' colorScheme='blue' mt='20px' w='100%' onClick={handleLogin}>Register</Button>
